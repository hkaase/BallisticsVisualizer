...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        trajectoryChart = new QChartView(groupBox_3);
        trajectoryChart->setObjectName("trajectoryChart");
        trajectoryChart->setGeometry(QRect(0, 20, 391, 391));
        ...
        calcButton = new QPushButton(groupBox_2);
        calcButton->setObjectName("calcButton");
        calcButton->setGeometry(QRect(60, 520, 261, 23));
        ...
        QObject::connect(calcButton, &QPushButton::clicked, trajectoryChart, qOverload<>(&QChartView::repaint));
